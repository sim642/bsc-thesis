...
\begin{table}[h]
	...
	\hline
	\multirow{2}{*}{Alt-üles} & \texttt{equal} & 468 & \presim 40 & \presim 70 \\
	%\cline{2-5}
	 & \texttt{leq} & 468 & \presim 40 & \presim 64 \\
	\hline
...
Mõnede omaduste testimisel tekkisid erindid enne kui kehtivust kontrollida oli võimalik. Selleks oli kaks põhilist põhjust:
\begin{enumerate}[nosep]
	\item Domeen ei moodusta täielikku võre ning elementide $\bot$ ja $\top$ asemel antakse erind. Sel põhjusel lõpevad erindiga domeeni \texttt{Integers} testid, mis kontrollivad vähima ja suurima elemendiga seotud omadusi.
	\item Jagamise abstraktsioonide kontrollimisel tekkis nulliga jagamine.
\end{enumerate}
