...
\begin{enumerate}
	...
	\item Mõned programmide vead esinevad väga spetsiifilistel juhtudel või on raskesti esilekutsutavad (nt mitmelõimelisusega seotud vead), mistõttu dünaamilise analüüsiga on neid keeruline avastada. Näiteks FindBugs™\footnote{\url{http://findbugs.sourceforge.net/} (13.05.2018)} otsib Java programmidest vigu.
