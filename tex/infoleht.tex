...
Selleks määratakse andmevooanalüüsiga programmi võimalikud seisundid, mida vaadeldakse ligikaudselt ja mis moodustavad abstraktse domeeni. Teostatav analüüs on abstraktse interpretatsiooni teooria kohaselt korrektne (\ingl{sound}), kui kasutatav domeen rahuldab teatud matemaatilisi omadusi.
